var emailLabel = document.querySelector('#loginEmailLabel'), email = document.querySelector('#fos_user_registration_form_email'), pseudo = document.querySelector('#fos_user_registration_form_username'), firstname = document.querySelector('#fos_user_registration_form_firstname'), lastname = document.querySelector('#fos_user_registration_form_lastname'), nationality = document.querySelector('#fos_user_registration_form_nationalite'), birthdate = document.querySelector('#fos_user_registration_form_dateNaissance'), birthdate = document.querySelector('#fos_user_registration_form_dateNaissance'), langue = document.querySelector('#fos_user_registration_form_langues'), photo = document.querySelector('#fos_user_registration_form_photoP'), desc = document.querySelector('#fos_user_registration_form_descriptions'), sexe = document.querySelector('#fos_user_registration_form_sexe'), etat = document.querySelector('#fos_user_registration_form_etat'), code = document.querySelector('#fos_user_registration_form_code'), tel = document.querySelector('#fos_user_registration_form_tel'), passwordLabel = document.querySelector('#loginPasswordLabel'), password = document.querySelector('#fos_user_registration_form_plainPassword_first'), showPasswordCheck = document.querySelector('#showPasswordCheck'), showPasswordToggle = document.querySelector('#showPasswordToggle'), mySVG = document.querySelector('.svgContainer'), twoFingers = document.querySelector('.twoFingers'), armL = document.querySelector('.armL'), armR = document.querySelector('.armR'), eyeL = document.querySelector('.eyeL'), eyeR = document.querySelector('.eyeR'), nose = document.querySelector('.nose'), mouth = document.querySelector('.mouth'), mouthBG = document.querySelector('.mouthBG'), mouthSmallBG = document.querySelector('.mouthSmallBG'), mouthMediumBG = document.querySelector('.mouthMediumBG'), mouthLargeBG = document.querySelector('.mouthLargeBG'), mouthMaskPath = document.querySelector('#mouthMaskPath'), mouthOutline = document.querySelector('.mouthOutline'), tooth = document.querySelector('.tooth'), tongue = document.querySelector('.tongue'), chin = document.querySelector('.chin'), face = document.querySelector('.face'), eyebrow = document.querySelector('.eyebrow'), outerEarL = document.querySelector('.earL .outerEar'), outerEarR = document.querySelector('.earR .outerEar'), earHairL = document.querySelector('.earL .earHair'), earHairR = document.querySelector('.earR .earHair'), hair = document.querySelector('.hair'), bodyBG = document.querySelector('.bodyBGnormal'), bodyBGchanged = document.querySelector('.bodyBGchanged');
...
function onPseudoFocus(e) {
    activeElement = "pseudo";
    e.target.parentElement.classList.add("focusWithText");
    //stopBlinking();
    //calculateFaceMove();
    onEmailInput();
...
function onPseudoBlur(e) {
    activeElement = null;
    setTimeout(function() {
        if(activeElement == "pseudo") {
        } else {
            if(e.target.value == "") {
                e.target.parentElement.classList.remove("focusWithText");
            }
...
function initLoginForm() {
    ...
    pseudo.addEventListener('focus', onPseudoFocus);
    pseudo.addEventListener('blur', onPseudoBlur);
    firstname.addEventListener('focus', onFirstnameFocus);
    firstname.addEventListener('blur', onFirstnameBlur);
    lastname.addEventListener('focus', onLastnameFocus);
    lastname.addEventListener('blur', onLastnameBlur);
    nationality.addEventListener('focus', onNationalityFocus);
    nationality.addEventListener('blur', onNationalityBlur);
    birthdate.addEventListener('focus', onBirthdateFocus);
    birthdate.addEventListener('blur', onBirthdateBlur);
    langue.addEventListener('focus', onLanguesFocus);
    langue.addEventListener('blur', onLanguesBlur);
    photo.addEventListener('focus', onPhotoFocus);
    photo.addEventListener('blur', onPhotoBlur);
    desc.addEventListener('focus', onDescFocus);
    desc.addEventListener('blur', onDescBlur);
    sexe.addEventListener('focus', onSexeFocus);
    sexe.addEventListener('blur', onSexeBlur);
    etat.addEventListener('focus', onEtatFocus);
    etat.addEventListener('blur', onEtatBlur);
    code.addEventListener('focus', onCodeFocus);
    code.addEventListener('blur', onCodeBlur);
    tel.addEventListener('focus', onTelFocus);
    tel.addEventListener('blur', onTelBlur);
